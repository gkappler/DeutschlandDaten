...
DeutschlandDaten.savefigs(p, "Demographie_Deutschland_Prozent", data = "Datenquelle: Statistisches Bundesamt Code: 12411-0006")

let title="Demographie (Bevölkerungszahl)\nder Bundesrepublik Deutschland der Jahre", yt = 0:8, yl=(00,85e6),
    ...
    DeutschlandDaten.savefigs(p, "Demographie_Deutschland_interpoliert", data = "Datenquelle: Statistisches Bundesamt Code: 12411-0006")
end
...
DeutschlandDaten.savefigs(p, "Sterbezahlen_Deutschland_monatlich")
